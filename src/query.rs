...
//! file for aws-sns to take until 2026-09-14, and the http technology from
//! then until the owner's ruling of 2026-09-22: what AWS speaks is shared
//! through the AWS crate, never sideways (ADR-0044).
//!
